...
test("preview serves the site and assets without exposing hidden files", async (t) => {
  ...
  for (const path of ["/src/app.js", "/games.json", "/styles.css", "/assets/mona-maze.png", "/assets/flappy-copilot.png", "/assets/mona-cover.svg", "/assets/octocat-candy.svg", "/assets/fonts/Silkscreen-Regular.ttf"]) {
